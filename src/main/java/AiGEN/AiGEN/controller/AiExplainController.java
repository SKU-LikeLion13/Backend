...
//        return explainAggregationService.explainPlatformTotals(session, dateRange);
//    }
//
//    @Operation(
...
//    ) {
//        validate(anonId);
//        if (platformCode == null || platformCode.isBlank()) throw new InvalidHeaderException("platformCode가 비어 있습니다.");
//        UserSession session = userSessionService.getOrCreate(anonId);
//        return explainAggregationService.explainPlatformMonthly(session, platformCode, dateRange);
//    }
//
//    private void validate(String anonId) {
//        if (anonId == null || anonId.isBlank()) throw new InvalidHeaderException("X-Anon-Id 헤더가 없습니다.");
//    }
//}
